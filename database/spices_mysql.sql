...
INSERT INTO `settings` (`key`, `value`) VALUES ('announcement', 'Free shipping on orders over ₹999 · Freshly ground to order');

-- users (2 rows)
INSERT INTO `users` (`id`, `name`, `email`, `phone`, `password_hash`, `role`, `status`, `created_at`) VALUES ('1', 'Store Admin', 'admin@saffra.test', NULL, '$2y$12$HyYGptBkymtBLVH60cPn9eFIGBbSqRi7DwYvR41NWHdfh44FnFSae', 'admin', 'active', '2026-06-27 10:35:01');
INSERT INTO `users` (`id`, `name`, `email`, `phone`, `password_hash`, `role`, `status`, `created_at`) VALUES ('2', 'Maya Patel', 'maya@example.com', NULL, '$2y$12$qTWX6myD4h5ODPHOr65lkOoPMvteVUUhaRw6jvgAF1Syneky5khPe', 'customer', 'active', '2026-06-27 10:35:01');
...
-- reviews (6 rows)
INSERT INTO `reviews` (`id`, `product_id`, `author_name`, `rating`, `title`, `body`, `is_approved`, `created_at`) VALUES ('1', '1', 'Aisha', '5', 'Golden everything', 'The colour is unreal and the aroma fills the kitchen. My curries have never looked better.', '1', '2026-06-27 10:35:02');
INSERT INTO `reviews` (`id`, `product_id`, `author_name`, `rating`, `title`, `body`, `is_approved`, `created_at`) VALUES ('2', '1', 'Tom', '5', 'Best turmeric', 'You can tell this is fresh. Worlds apart from supermarket jars.', '1', '2026-06-27 10:35:02');
INSERT INTO `reviews` (`id`, `product_id`, `author_name`, `rating`, `title`, `body`, `is_approved`, `created_at`) VALUES ('3', '4', 'Priya', '5', 'Fragrant and bold', 'Grinding these fresh changed my cooking. Citrusy and punchy.', '1', '2026-06-27 10:35:02');
INSERT INTO `reviews` (`id`, `product_id`, `author_name`, `rating`, `title`, `body`, `is_approved`, `created_at`) VALUES ('4', '6', 'Daniel', '5', 'Restaurant quality', 'This garam masala tastes like my favourite restaurant. Incredible finish.', '1', '2026-06-27 10:35:02');
INSERT INTO `reviews` (`id`, `product_id`, `author_name`, `rating`, `title`, `body`, `is_approved`, `created_at`) VALUES ('5', '5', 'Elena', '5', 'Worth every thread', 'A pinch transforms a dish. Beautiful deep red threads.', '1', '2026-06-27 10:35:02');
INSERT INTO `reviews` (`id`, `product_id`, `author_name`, `rating`, `title`, `body`, `is_approved`, `created_at`) VALUES ('6', '11', 'Sam', '5', 'Perfect gift', 'Gave this to my dad who loves to cook. The box is gorgeous.', '1', '2026-06-27 10:35:02');
